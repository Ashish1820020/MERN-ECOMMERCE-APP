  ...
  return (
    <Wrapper className="checkout-price-section">
      ...
      <div>
        ...
        <p className="right">
          {" "}
          <FormatPrice price={totalAmount} decimal={2} />{" "}
        </p>
      </div>
      <div>
        ...
        <p className="right">
          {" "}
          − <FormatPrice
            price={totalAmount - discountedPrice}
            decimal={2}
          />{" "}
        </p>
      </div>
      ...
      <div className="total">
        ...
        <p className="total-right">
          {" "}
          <FormatPrice price={discountedPrice} decimal={2} />{" "}
        </p>
      </div>
      <div>
        <span>
          You will save ₹{totalAmount - discountedPrice} on this order
        </span>
      </div>
    </Wrapper>
  );
