                  ...
                  <div className="row">
                    <div className="col">
                      <div className="slider-text-info  slider-content-left  slider-text-left">
                          <span style={{"color":" #6f6f6f"}} className="subtitle e1">Get 35% off new tablet</span>
                          <h2 style={{"color": "#232f3e"}} className="title e1">Best tablet smart pad</h2>
                          <button className="slider-btn btn btn-style e1" onClick={() => navigate('/products')}><NavLink>Shop now</NavLink></button>
                      </div>
                    </div>
                  </div>
                </div>
